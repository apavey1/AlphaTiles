...
public class Thailand extends GameActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (refType != null && !refType.contains("SYLLABLE")) {
            if (refWord != null) {
                preloadGeneralAudio(refWord.wordInLWC, true);
            } else if (refTile != null) {
                preloadGeneralAudio(refTile.audioName, true);
            }
        }
        playAgain();
    ...
    public void playAgain() {
        ...
        if (refType != null) {
            if (refType.startsWith("WORD") && refWord != null) {
                playInitialPrompt(refWord.wordInLWC);
            } else if (refType.startsWith("TILE") && refTile != null) {
                playInitialPrompt(refTile.audioName);
            }
        }
    }
    ...
    public void playCorrectSoundThenActiveTileClip0(final boolean playFinalSound) {
